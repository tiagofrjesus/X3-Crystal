<#
.SYNOPSIS
  Redesenha o cabeçalho do TEB_PIECE.rpt: empresa à esquerda, terceiro (1ª linha) à direita,
  e remove a coluna "Terceiro" da tabela de detalhe.
...
$cs = Get-Content (Join-Path $PSScriptRoot 'X3RptPieceHeaderRedesign.cs') -Raw -Encoding UTF8
...
$res = [X3RptPieceHeaderRedesign]::Build($RptPath,$OutPath,$WorkDsn,$WorkDb,$WorkUser,$WorkPass)
Write-Host "LOG: $res"
